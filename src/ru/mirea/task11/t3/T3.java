...
public class T3 {
    ...
    private static void initColorMenu(JMenu colorMenu, JTextArea area) {
        ...
        colorMenu.getAccessibleContext().setAccessibleDescription("" +"Here you can choose text color");
    ...
    private static void initFontMenu(JMenu fontMenu, JTextArea area) {
        ...
        fontMenu.getAccessibleContext().setAccessibleDescription("" + "Here you can choose text font");
        ...
        JRadioButtonMenuItem rbOpenSans = new JRadioButtonMenuItem("Courier");

        rbTimesNewRoman.setActionCommand("TimesNewRoman");
        rbArial.setActionCommand("Arial");
        rbOpenSans.setActionCommand("Courier");
        ...
        rb.addActionListener(actionEvent -> {
            switch(actionEvent.getActionCommand()) {
                ...
                case "Arial":
                    ...
                    break;
                case "OpenSans":
                    area.setFont(new Font("Courier", Font.PLAIN, 16));
                    break;
            }
        });
    }
